...
start = Sys.time()
AWB_ECA_stan_fit_no_CO2 <- model$sample(data = data_list, seed = 1234, refresh = 10, init = init_theta, iter_sampling = 3000, iter_warmup = 500, chains = num_chains, parallel_chains = num_chains, adapt_delta = 0.95)
stop = Sys.time()
elapsed = stop - start
