...
AWB_ECA_stan_fit <- model$sample(data = data_list, seed = 1234, refresh = 10, init = init_theta, iter_sampling = 10, iter_warmup = 10, chains = 4, parallel_chains = 4, adapt_delta = 0.92)
