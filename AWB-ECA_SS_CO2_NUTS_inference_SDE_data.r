...
AWB_ECA_stan_fit <- model$sample(data = data_list, seed = 1234, refresh = 50, init = init_theta, iter_sampling = 6250, iter_warmup = 1000, chains = 4, parallel_chains = 4, adapt_delta = 0.95)
