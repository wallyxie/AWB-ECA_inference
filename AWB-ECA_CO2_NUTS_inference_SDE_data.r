...
AWB_ECA_stan_fit_CO2_x_post <- as_tibble(AWB_ECA_stan_fit_CO2$draws(c("x_hat_add_CO2"), format = "draws_df"))
write_csv(AWB_ECA_stan_fit_CO2_x_post, "NUTS_results/AWB-ECA_CO2_NUTS_inference_SDE_data_x_post.csv")
