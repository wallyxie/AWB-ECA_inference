...
AWB_ECA_stan_fit_CO2 <- model$sample(data = data_list, seed = 1234, refresh = 10, init = init_theta, iter_sampling = 2500, iter_warmup = 1000, chains = num_chains, parallel_chains = num_chains, adapt_delta = 0.95)

#Save Stan fit object and NUTS inference results.
AWB_ECA_stan_fit_CO2$save_object(file = "NUTS_results/AWB-ECA_CO2_NUTS_inference_SDE_data.rds")
AWB_ECA_stan_fit_CO2_theta_post <- as_tibble(AWB_ECA_stan_fit_CO2$draws(c("u_Q_ref", "Q", "a_MSA", "K_DE", "K_UE", "V_DE_ref", "V_UE_ref", "Ea_V_DE", "Ea_V_UE", "r_M", "r_E", "r_L"), format = "draws_df"))
write_csv(AWB_ECA_stan_fit_CO2_theta_post, "NUTS_results/AWB-ECA_CO2_NUTS_inference_SDE_data_theta_post.csv")
AWB_ECA_stan_fit_CO2_theta_and_x_post <- as_tibble(AWB_ECA_stan_fit_CO2$draws(c("u_Q_ref", "Q", "a_MSA", "K_DE", "K_UE", "V_DE_ref", "V_UE_ref", "Ea_V_DE", "Ea_V_UE", "r_M", "r_E", "r_L", "x_hat_add_CO2"), format = "draws_df"))
write_csv(AWB_ECA_stan_fit_CO2_theta_and_x_post, "NUTS_results/AWB-ECA_CO2_NUTS_inference_SDE_data_theta_and_x_post.csv")
AWB_ECA_stan_fit_CO2_post_summary <- as_tibble(AWB_ECA_stan_fit_CO2$summary(c("u_Q_ref", "Q", "a_MSA", "K_DE", "K_UE", "V_DE_ref", "V_UE_ref", "Ea_V_DE", "Ea_V_UE", "r_M", "r_E", "r_L", "x_hat_add_CO2")))
write_csv(AWB_ECA_stan_fit_CO2_post_summary, "NUTS_results/AWB-ECA_CO2_NUTS_inference_SDE_data_post_summary.csv")
